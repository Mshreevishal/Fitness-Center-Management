...
* Manage members and trainers efficiently
* Automate membership tracking and expiry alerts
* Streamline booking and attendance management
...
### 🔹 **Shree Vishal – Project Lead & Salesforce Developer**

* Designed overall system architecture
* Developed custom objects, fields, and relationships
...
* Designed user-friendly layouts using Lightning App Builder
* Customized page layouts and navigation
...
* Managed data entry and validation processes
* Created and tested sample datasets
...
* Analyzed system data for insights
...
As a gym administrator at FitHub Fitness Center, I want to efficiently manage member data, trainer assignments, and membership plans using a centralized Salesforce CRM system.
